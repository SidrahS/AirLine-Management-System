...
FILE*reservations, *flights , *crew , *tmpf , *fp , *p1 , *p2 ;
...
reservation() //add new reservation
	...
	edit_flight(){//flight_edit 
		...
		rewind(flights);
				...
				while(fread(&f1 , sizeof(f1) ,1 ,flights)==1)
				{
					if(strcmp(f1.fnumber,flight_edit )==0)
					{
...
//portal()
//{
//		p1=fopen("username.txt","r");
//	p2=fopen("password.txt","r");
//	printf("Press 1 for USER PANEL and press 2 for ADMIN PANEL\n");
//	action=getch();
//	switch(action)
//	{
//		case '1':
...
//	
//	int i;
//	for(i=0;u1.name[i]!='\0';i++)
//	{
//		if(u1.name[i]>=65 && u1.name[i]<=91)
//		{
//			u1.name[i]=u1.name[i]+3;
//			if(u1.name[i]>=89)
//			{
//				u1.name[i]-=26;
//			}
...
//		}
//		
//		else if(u1.name[i]>=97 && u1.name[i]<=122)
//		{
//			u1.name[i]=u1.name[i]+3;
//			if(u1.name[i]>=120)
//			u1.name[i]-=26;
...
//	}
//	
//	for(i=0;u1.pass[i]!='\0';i++)
//	{
//		if(u1.pass[i]>=65 && u1.pass[i]<=91)
//		{
//			u1.pass[i]=u1.pass[i]+3;
//			if(u1.pass[i]>=89)
//			{
//				u1.pass[i]-=26;
//			}
...
//		}
//		
//		else if(u1.pass[i]>=97 && u1.pass[i]<=122)
//		{
//			u1.pass[i]=u1.pass[i]+3;
//			if(u1.pass[i]>=120)
//			u1.pass[i]-=26;
...
//	}
//	
//	while(fread(&u,sizeof(u),1,p2)==0)	
//	{
//		if (strcmp(u1.pass,u.pass) >0)
//		{
//			printf("Welcome!");
//			break;
//		}
